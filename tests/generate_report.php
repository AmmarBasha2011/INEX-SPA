...
<body>
    ...
    <div class="main">
        ...
        <div id="cli" class="section content-section" style="display:none;">
            <h2>CLI Commands</h2>
            <div class="filters">
        ...
        <div id="core" class="section content-section" style="display:none;">
        ...
        <div id="web" class="section content-section" style="display:none;">
            <h2>Web Routes</h2>
            <table>
                <thead>
                    <tr>
        ...
        <div id="fixed" class="section content-section" style="display:none;">
            <h2>Fixed Issues</h2>
