...
$fixedIssues = [
    ...
    [
        ...
        'title'       => 'Core Database SQLite support',
        'description' => 'Added support for SQLite driver in Database and executeSQLFilePDO classes.',
        'status'      => 'FIXED',
    ],
    [
        'id'          => 'core-security-xss',
        'title'       => 'Core Security XSS sanitization',
        'description' => 'Fixed Security::sanitizeInput to correctly strip script tags before escaping.',
        'status'      => 'FIXED',
    ],
];
