...
/**
 * Connects to a MySQL or SQLite database and executes a series of SQL queries from a specified file.
 *
 ...
 *
 * @param string $host     The hostname or IP address of the database server (or file path for SQLite).
 * @param string $user     The username for the database connection (null for SQLite).
 * @param string $password The password for the database connection (null for SQLite).
 * @param string $database The name of the database (or file path for SQLite).
