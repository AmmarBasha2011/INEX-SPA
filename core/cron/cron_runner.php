...
if (file_exists(PROJECT_ROOT.'/core/functions/PHP/getEnvValue.php')) {
    ...
    if (!function_exists('getEnvValue')) {
        /**
         * A fallback function to retrieve an environment variable.
         *
         * This function provides a basic mechanism to get an environment variable
         * if the primary `getEnvValue` function from the core framework is not available.
